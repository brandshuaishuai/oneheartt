  ...
  <div id="icon-edit" class="icon32 icon32-posts-post"></div>
	...
	<?php
			...
			foreach ($myData as $data)
			{
				...
				<tr class="<?php if ($i&1) { echo'alternate'; } else { echo ''; }?>">
					...
					<a title="Click to Edit" href="<?php echo WP_IHRSS_ADMIN_URL; ?>&amp;ac=edit&amp;did=<?php echo $data['Ihrss_id']; ?>">
						<?php _e('Edit', 'image-horizontal-reel-scroll-slideshow'); ?>
					</a>  
					</span>
					<span class="trash">
					&nbsp; 
					<a title="Click to Delete" onClick="javascript:Ihrss_delete('<?php echo $data['Ihrss_id']; ?>')" href="javascript:void(0);">
						<?php _e('Delete', 'image-horizontal-reel-scroll-slideshow'); ?>
					</a>
					</span> 
					</td>
	  ...
	  <div class="tablenav bottom">
			...
			<div>
				<a href="<?php echo WP_IHRSS_ADMIN_URL; ?>&amp;ac=add"><input class="button action" type="button" value="<?php _e('Add New', 'image-horizontal-reel-scroll-slideshow'); ?>" /></a>
				<a href="<?php echo WP_IHRSS_ADMIN_URL; ?>&amp;ac=set"><input class="button action" type="button" value="<?php _e('Widget setting', 'image-horizontal-reel-scroll-slideshow'); ?>" /></a>
				<a href="<?php echo WP_Ihrss_FAV; ?>" target="_blank"><input class="button action" type="button" value="<?php _e('Help', 'image-horizontal-reel-scroll-slideshow'); ?>" /></a>
		  	</div>
	  </div>
	  <p class="description">
