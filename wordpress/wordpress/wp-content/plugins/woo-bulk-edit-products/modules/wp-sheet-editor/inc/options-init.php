			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'desc' => __('When you have 1000 posts , you might want to open the spreadsheet and start editing from post 200. This option lets you open the spreadsheet and start from a specific post index instead of starting from the beginning.', VGSE()->textname),
						'default' => 0,
					),
					array(
					...
					array(
						...
						'desc' => __('When you load the spreadsheet, we get all the columns at once from the database to make it faster, this is called prefetch. This can cause issues if you have hundreds of columns or rare database setups.', VGSE()->textname),
						'default' => false,
					),
					array(
