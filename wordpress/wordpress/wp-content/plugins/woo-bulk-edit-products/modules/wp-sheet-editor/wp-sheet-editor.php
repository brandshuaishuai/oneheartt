...
if (!class_exists('WP_Sheet_Editor')) {
	...
	class WP_Sheet_Editor {
		...
		function init() {
			...
			load_plugin_textdomain(VGSE()->textname, false, basename(dirname(__FILE__)) . '/lang/');
		...
		function get_support_links($link_key = null, $field = 'all', $campaign = 'help') {
			...
			$support_links = array(
				...
				'guides' => array(
					...
					'description' => __('We have +100 tutorials and guides on our blog', VGSE()->textname),
				),
				'contact_us' => array(
