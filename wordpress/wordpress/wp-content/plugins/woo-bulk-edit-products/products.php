    ...
    class WP_Sheet_Editor_WC_Products
    {
        ...
        function notify_wrong_core_version()
        {
			...
			<div class="notice notice-error">
				<p><?php 
            _e( 'Please update the WP Sheet Editor plugin and all its extensions to the latest version, the CORE plugin should be version 2.5.3 or higher. The plugin "' . $plugin_data['Name'] . '" requires that version.', vgse_wc_products()->textname );
            ?></p>
			</div>
			<?php 
        }
