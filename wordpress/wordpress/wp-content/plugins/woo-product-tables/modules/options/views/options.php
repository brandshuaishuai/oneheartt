...
class optionsViewWtbp extends viewWtbp {
    ...
    public function getAdminPage() {
		...
		if(isset($tabs[ $activeTab ]) && isset($tabs[ $activeTab ]['callback'])) {
			//frameWtbp::_()->getModule('promo')->getModel()->saveUsageStat('tab.'. $activeTab);
	...
	public function getTabContent() {
		frameWtbp::_()->addScript('admin.mainoptions', $this->getModule()->getModPath(). 'js/admin.mainoptions.js');
	...
	public function getSettingsTabContent() {
		frameWtbp::_()->addScript('admin.settings', $this->getModule()->getModPath(). 'js/admin.settings.js');
