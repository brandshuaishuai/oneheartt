 ...
 */
$copyright = education_method_get_option('education_method_copyright');
...
<!-- 					<a href="<?php echo esc_url( __( 'https://www.amplethemes.com/', 'education-method' ) ); ?>"
                    ><?php
						/* translators: %s: CMS name, i.e. WordPress. */
						printf( esc_html__( ' Design & develop by AmpleThemes %s', 'education-method' ), '' );
						?></a>	</p> -->
					 </p>
